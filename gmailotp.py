...
def getFyersOTP(otpdate):
    ...
    for mssg in mssg_list:
        ...
        for one in headr: # getting the Subject
            if one['name'] == 'Subject':
                ...
                if msg_subject == 'FYERS Login OTP - Email Notification':
    ...
    #			pass
                    ...
                    try:
                        ...
                        print('Printing Message Body')
                        #print(mssg_body)
                        lines = str(mssg_body).splitlines()
                        for line in lines:
                            if 'Enter OTP for sign in to your FYERS account is:' in line:
                                splt = line.split(': ')
                                if len(splt) > 1:
                                    print("Otp Received is ::"+splt[1])
                                    return splt[1]
